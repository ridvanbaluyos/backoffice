                ...
                <div class="nav-collapse collapse navbar-inverse-collapse">
                    ...
                    <ul class="nav">
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="/hrad/leaves">Leaves</a></li>
                                <li><a href="/hrad/obot">Official Business &amp; Overtime</a></li>
                                <li><a href="/hrad/work-from-home-request">Work from Home</a></li>
                                <!-- <li class="nav-header">Admministration</li> -->
                                <li><a href="/hrad/personnel-requisition-request">Personnel Requisition</a></li>
                                <li><a href="/hrad/company-loan-request">Company Loan</a></li>
                                <li><a href="/hrad/colleages-diary">Colleague's Diary</a></li>
                              <li class="divider"></li>
                              <li class="nav-header">Configuration</li>
                              <li><a href="/hrad/employees">Employees</a></li>
                            </ul>
                        </li>
                    </ul>
                    ...
                    <ul class="nav">
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="#">Vehicle Requisition (VR)</a></li>
                                <li><a href="#">Personal Mobile Usage Declaration (PMUD)</a></li>
                                <li><a href="#">Purchase Requisition</a></li>
                                <li><a href="#">Repair Requisition</a></li>
